...
class IntermediateCode: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imgGif2.loadGif(name: "vAbdominal")
        imgGif3.loadGif(name: "mountainClimber")
        imgGif4.loadGif(name: "buttBridge")
        imgGif5.loadGif(name: "touchHeels")
        imgGif6.loadGif(name: "crunchBicycle")
    }
