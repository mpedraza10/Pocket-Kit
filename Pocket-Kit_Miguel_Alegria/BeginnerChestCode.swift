...
class BeginnerChestCode: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imgGif2.loadGif(name: "pushInclination")
        imgGif3.loadGif(name: "pushKnees")
        imgGif4.loadGif(name: "pushUps")
        imgGif5.loadGif(name: "diamondPush")
        imgGif6.loadGif(name: "pushCaja")
    }
