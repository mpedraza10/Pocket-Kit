...
class IntermediateArmCode: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imgGif2.loadGif(name: "tricepsFloor")
        imgGif3.loadGif(name: "military")
        imgGif4.loadGif(name: "pushUpsR")
        imgGif5.loadGif(name: "pushUps")
        imgGif6.loadGif(name: "burpees")
    }
