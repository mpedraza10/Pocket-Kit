...
class IntermediateChestCode: UIViewController {

    @IBOutlet weak var imgGig1: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        imgGig1.loadGif(name: "saltoDeTijera")
        imgGif2.loadGif(name: "pushKnees")
        imgGif3.loadGif(name: "pushUps")
        imgGif4.loadGif(name: "stepped")
        imgGif5.loadGif(name: "hinduPush")
        imgGif6.loadGif(name: "pushUpsR")
    }
